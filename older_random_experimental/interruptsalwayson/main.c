...
float min_rpm = 300;                                         //minimum RPM for translation / throttling to kick in (if lower than - gets full power)
float max_allowed_rpm = 5000;                                //max_rpm allowed before cutting power
float max_g = 190;                    	                      //max g's before cutting power
