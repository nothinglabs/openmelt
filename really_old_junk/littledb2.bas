...
Enable Int0
Config Int0 = Change
On Int0 Rc_change                                           'call RC_change anytime RC pins go up or down
'Msk0 = &B00011001                                           'sets mask so that only RC pins trigger interrupt
...
Const Min_rpm = 300                                         'lower RPM for flight testing
'Const Min_rpm = 700                                         'minimum RPM for translation / throttling to kick in

'for hover
Const Radius = 3.22                                         'effective radius of circle for accel (centimeters) - seems to be off sometimes...
