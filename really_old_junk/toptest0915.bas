...
'if throttle is lower than 90 bot stays powered down
   ...
   Low_voltage_cutoff = Full_charge_voltage * 89            'low_voltage_cutoff is 89% of full charge voltage
...
'    If Led_on => Periodms_long Then                         'if led_on is "later" or at end of cycle - shift led_on behind by one cycle
'        Led_on = Led_on - Periodms_long
'    End If
