...
Const Max_allowed_rpm = 2750                                'max_rpm allowed before cutting power
Const Max_g = 1500                                          'max G's before cutting power (bogus number)
...
'testing!!!
'   If Backward = 1 Then Throttle_percent = 20
...
'do full reverse on other motor if moving forwards
